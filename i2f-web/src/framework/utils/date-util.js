...
const DateUtil = {
  ...
  addYears (date, num) {
    const mom = this.date2moment(date).add(num, 'years')
    return this.moment2date(mom)
  },
  addMonths (date, num) {
    const mom = this.date2moment(date).add(num, 'months')
    return this.moment2date(mom)
  },
  addWeeks (date, num) {
    const mom = this.date2moment(date).add(num, 'weeks')
    return this.moment2date(mom)
  },
  addDays (date, num) {
    const mom = this.date2moment(date).add(num, 'days')
    return this.moment2date(mom)
  },
  addHours (date, num) {
    const mom = this.date2moment(date).add(num, 'hours')
    return this.moment2date(mom)
  },
  addMinutes (date, num) {
    const mom = this.date2moment(date).add(num, 'minutes')
    return this.moment2date(mom)
  },
  addSeconds (date, num) {
    const mom = this.date2moment(date).add(num, 'seconds')
    return this.moment2date(mom)
  },
  addMilliseconds (date, num) {
    const mom = this.date2moment(date).add(num, 'milliseconds')
    return this.moment2date(mom)
  }
}
